...
def update_cfg(args):
    ...
    elif(category == 'mnistfc'):
        args.subtract_target = True
    elif(category == 'oval21'):
        args.subtract_target = True
        args.dataset = 'cifar20'
        Setting.N_VERIF_CORES = 24
    elif(category == 'cifar_biasfield'):
    ...
    elif(category =='tllverifybench'):
        Setting.N_VERIF_CORES = 24

    elif 'test/test_' in args.model:
        args.dataset = 'test'
